...
driver.find_element(By.XPATH, "//div[contains(@class, 'a-box a-alert-inline a-alert-inline-info auth-inlined-information-message a-spacing-top-mini') and //div[contains(@class, 'a-alert-content')]]")
